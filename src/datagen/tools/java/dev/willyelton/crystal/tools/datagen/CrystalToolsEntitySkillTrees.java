        ...
        return SkillData.builder(null)
                ...
                .tier()
                    ...
                    .entityAttributeNode(7, entitySpeed(2), desc.entitySpeed(), attr(Attributes.MOVEMENT_SPEED), 0.025F)
                        .nodeRequirement(3)
                .tier()
                    .entityDataNode(8, lifesteal(1), desc.entityLifesteal(), dev.willyelton.crystal.core.utils.EntitySkills.LIFESTEAL, 0.25F)
                ...
                .tier()
                    ...
                    .entityAttributeNode(16, entitySpeed(4), desc.entitySpeed(), attr(Attributes.MOVEMENT_SPEED), 0.025F)
                        .nodeRequirement(12)
                .tier()
                    .entityDataNode(17, lifesteal(2), desc.entityLifesteal(), dev.willyelton.crystal.core.utils.EntitySkills.LIFESTEAL, 0.25F)
                        .previousTierOrRequirements()
