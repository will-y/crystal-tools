...
import static dev.willyelton.crystal.core.utils.constants.SkillConstants.BLOCKS_ATTACKS;
...
public class CrystalToolsItemSkillTrees {
    ...
    public void registerSkillTrees() {
        ...
        context.register(ResourceKey.create(DatapackRegistryEvents.SKILL_DATA_REGISTRY_KEY_ITEMS,
                ModRegistration.CRYSTAL_SPEAR.getId()), spear());
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(3, durability(2), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(1)
                    .dataComponentNode(4, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                ...
                .tier()
                    ...
                    .enchantmentNode(9, fortune(3), desc.fortune(3), Enchantments.FORTUNE, 3)
                        .previousTierOrRequirements()
                        .notNodeRequirement(8, 22)
                    .dataComponentNode(10, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                        .nodeRequirement(4)
                    .optional(axe)
                ...
                .tier()
                    ...
                    .attributeNode(15, reach(2), desc.reach(), List.of(attr(Attributes.BLOCK_INTERACTION_RANGE), attr(Attributes.ENTITY_INTERACTION_RANGE)), 1)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                    .dataComponentNode(16, AUTO_PICKUP, desc.autoPickup(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_PICKUP.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .infiniteDataComponentNode(17, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(18, MINING_3x3, desc.mining3x3(), DataComponents.HAS_3x3.getId(), 1)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(19, !axe ? VEIN_MINING : AXE_VEIN_MINING, desc.veinMining(axe), DataComponents.VEIN_MINER.getId(), 1)
                        .previousTierOrRequirements()
                        .subText(VEIN_MINING_SUBTEXT, "#ABABAB")
                    .dataComponentNode(20, AUTO_SMELTING, desc.autoSmelting(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_SMELT.getId(), 1)
                        .previousTierOrRequirements()
                ...
                .tier()
                    .optional(name.equals("Pickaxe"))
                        .dataComponentNode(21, TORCH, desc.torch(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.TORCH.getId(), 1)
                            .previousTierOrRequirements()
                            .subText(TORCH_SUBTEXT, "#ABABAB")
                    .endOptional()
                    .dataComponentNode(22, MODE_SWITCH, desc.mineMode(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.MINE_MODE.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(23, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                        .nodeRequirement(10)
                ...
                .tier()
                    ...
                    .infiniteAttributeNode(28, reach(0), desc.reach(), List.of(attr(Attributes.BLOCK_INTERACTION_RANGE), attr(Attributes.ENTITY_INTERACTION_RANGE)), 0.1F)
                        ...
                        .previousTierOrRequirements()
                .tier()
                    .enchantmentNode(29, fortune(5), desc.fortune(5), Enchantments.FORTUNE, 5)
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .attributeNode(7, knockbackResistance(1), desc.knockbackResistance(), attr(Attributes.KNOCKBACK_RESISTANCE), 0.1F)
                        .previousTierOrRequirements()
                    .attributeNode(8, knockback(1), desc.knockback(), attr(Attributes.ATTACK_KNOCKBACK), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(9, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                    .dataComponentNode(10, beheading(1), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .attributeNode(14, reach(1), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(15, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(16, lifesteal(1), desc.lifesteal(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.LIFESTEAL.getId(), 2)
                        .previousTierOrRequirements()
                    .attributeNode(17, knockbackResistance(2), desc.knockbackResistance(), attr(Attributes.KNOCKBACK_RESISTANCE), 0.1F)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                    .attributeNode(18, knockback(2), desc.knockback(), attr(Attributes.ATTACK_KNOCKBACK), 1)
                        .nodeRequirement(8)
                        .previousTierOrRequirements()
                    .dataComponentNode(19, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(9)
                        .previousTierOrRequirements()
                    .dataComponentNode(20, beheading(2), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(10)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .attributeNode(24, reach(2), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(14)
                        .previousTierOrRequirements()
                    .dataComponentNode(25, capturing(2), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 1)
                        .nodeRequirement(15)
                        .previousTierOrRequirements()
                .tier()
                    .enchantmentNode(26, desc, Enchantments.LOOTING, 3)
                        .previousTierOrRequirements()
                    .dataComponentNode(27, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierOrRequirements()
                    .dataComponentNode(28, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(19)
                        .previousTierOrRequirements()
                    .dataComponentNode(29, beheading(3), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(20)
                        .previousTierOrRequirements()
                ...
                .tier()
                    ...
                    .attributeNode(34, reach(3), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(24)
                        .previousTierOrRequirements()
                    .dataComponentNode(35, capturing(3), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 1)
                        .nodeRequirement(25)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .infiniteDataComponentNode(38, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(33)
                    .dataComponentNode(39, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F, 70)
                        .nodeRequirement(28)
                        .previousTierOrRequirements()
    ...
    private SkillData spear() {
        SkillTreeDescriptions desc = new SkillTreeDescriptions("Spear");

        return SkillData.builder(EquipmentSlot.MAINHAND)
                .tier()
                .attributeNode(0, attackDamage(1), desc.attackDamage(), attr(Attributes.ATTACK_DAMAGE), 1)
                .dataComponentNode(1, dash(1), desc.dash(), DataComponents.DASH.getId(), 1)
                .dataComponentNode(2, durability(1), desc.durability(), DURABILITY, 200)
                .tier()
                .attributeNode(3, attackDamage(2), desc.attackDamage(), attr(Attributes.ATTACK_DAMAGE), 1)
                .nodeRequirement(0)
                .dataComponentNode(4, dash(2), desc.dash(), DataComponents.DASH.getId(), 1)
                .nodeRequirement(1)
                .dataComponentNode(5, durability(2), desc.durability(), DURABILITY, 200)
                .nodeRequirement(2)
                .tier()
                ...
                .nodeRequirement(3)
                .previousTierOrRequirements()
                .dataComponentNode(12, dash(3), desc.dash(), DataComponents.DASH.getId(), 1)
                .nodeRequirement(4)
                .previousTierOrRequirements()
                .dataComponentNode(13, durability(3), desc.durability(), DURABILITY, 200)
                .nodeRequirement(5)
                ...
                .nodeRequirement(11)
                .previousTierOrRequirements()
                .dataComponentNode(22, dash(4), desc.dash(), DataComponents.DASH.getId(), 1)
                .nodeRequirement(12)
                .previousTierOrRequirements()
                .dataComponentNode(23, durability(4), desc.durability(), DURABILITY, 200)
                .nodeRequirement(13)
                ...
                .nodeRequirement(21)
                .previousTierOrRequirements()
                .dataComponentNode(32, dash(5), desc.dash(), DataComponents.DASH.getId(), 1)
                .nodeRequirement(22)
                .previousTierOrRequirements()
                .dataComponentNode(33, durability(4), desc.durability(), DURABILITY, 200)
                .nodeRequirement(23)
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(7, durability(2), desc.durability(), DURABILITY, 25)
                        .nodeRequirement(3)
                .tier()
                    .infiniteDataComponentNode(8, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1)
                        .previousTierOrRequirements()
    ...
    private SkillData helmet() {
        ...
        builder
                ...
                .enchantmentNode(17, enchantmentName(Enchantments.RESPIRATION, 3), desc.enchantment(enchantmentName(Enchantments.RESPIRATION, 3)), Enchantments.RESPIRATION, 3)
                    .previousTierOrRequirements()
                .infiniteDataComponentNode(18, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1)
                    .previousTierOrRequirements();
        ...
        builder
                .tier()
                    ...
                    .enchantmentNode(25, enchantmentName(Enchantments.THORNS, 3), desc.enchantment(enchantmentName(Enchantments.THORNS, 3)), Enchantments.THORNS, 3)
                        .previousTierOrRequirements()
                    .dataComponentNode(26, NIGHT_VISION, desc.nightVision(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.NIGHT_VISION.getId(), 1)
    ...
    private SkillData chestplate(boolean elytra) {
        ...
        builder
                .tier()
                    ...
                    .attributeNode(10, healthBonus(1), desc.healthBonus(),attr(Attributes.MAX_HEALTH), 2)
                        .previousTierOrRequirements();
        if (elytra) {
            builder.dataComponentNode(28, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                    .previousTierOrRequirements();
        }
        ...
        if (elytra) {
            builder.dataComponentNode(29, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                    .nodeRequirement(28)
                    .previousTierOrRequirements();
        }
        ...
        if (elytra) {
            builder.dataComponentNode(30, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                    .nodeRequirement(29)
                    .previousTierOrRequirements();
        }
        ...
        if (elytra) {
            builder.tier()
                    .dataComponentNode(31, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(30)
        ...
        builder
                .tier()
                    ...
                    .attributeNode(20, moveSpeed(2), desc.moveSpeed(), attr(Attributes.MOVEMENT_SPEED), 1)
                        .nodeRequirement(12)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(21, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1)
                        .previousTierOrRequirements();
        ...
        return builder
                ...
                .tier()
                    ...
                    .enchantmentNode(9, desc, Enchantments.FLAME, 0)
                        .previousTierOrRequirements()
                    .dataComponentNode(10, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                    .dataComponentNode(39, beheading(1), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(14, durability(3), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                    .dataComponentNode(42, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .enchantmentNode(16, desc, Enchantments.INFINITY, 0)
                        .previousTierOrRequirements()
                    .dataComponentNode(17, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(10)
                        .previousTierOrRequirements()
                    .dataComponentNode(40, beheading(2), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(39)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(21, durability(4), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(14)
                        .previousTierOrRequirements()
                .dataComponentNode(43, capturing(2), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                    .nodeRequirement(42)
                    .previousTierOrRequirements()
                .tier()
                    .enchantmentNode(22, desc, Enchantments.PUNCH, 3)
                        .nodeRequirement(15)
                        .previousTierOrRequirements()
                    .dataComponentNode(23, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierOrRequirements()
                    .dataComponentNode(24, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(17)
                        .previousTierOrRequirements()
                    .dataComponentNode(25, AUTO_TARGET, desc.autoTarget(false), DataComponents.AUTO_TARGET.getId(), 1F)
                        .previousTierOrRequirements()
                    .dataComponentNode(41, beheading(3), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(40)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(29, durability(5), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(21)
                        .previousTierOrRequirements()
                    .dataComponentNode(44, capturing(3), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .nodeRequirement(43)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .infiniteDataComponentNode(33, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(29)
                    .dataComponentNode(34, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(24)
                        .previousTierOrRequirements()
                .tier()
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    .infiniteDataComponentNode(4, durability(0), desc.durability(), DURABILITY, 10)
                        .nodeRequirement(2)
                    .infiniteDataComponentNode(5, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1)
                        .previousTierOrRequirements()
                .build();
    }
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(5, durability(2), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(2)
                .tier()
                    .dataComponentNode(6, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                ...
                .tier()
                    ...
                    .dataComponentNode(10, durability(3), desc.durability(), DURABILITY, 50)
                        ...
                        .previousTierAndRequirements()
                .tier()
                    .dataComponentNode(11, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(6)
                        .previousTierOrRequirements()
                ...
                .tier()
                    ...
                    .dataComponentNode(15, durability(4), desc.durability(), DURABILITY, 50)
                        ...
                        .previousTierAndRequirements()
                .tier()
                    .dataComponentNode(16, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(11)
                        .previousTierOrRequirements()
                    .dataComponentNode(17, doubleItems(3), desc.doubleItems(), DataComponents.DOUBLE_DROPS.getId(), 0.2F)
                        .nodeRequirement(12)
                        .previousTierAndRequirements()
                    .dataComponentNode(18, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierAndRequirements()
                .tier()
                    ...
                    .dataComponentNode(21, durability(5), desc.durability(), DURABILITY, 50)
                        ...
                        .previousTierAndRequirements()
                .tier()
                    .dataComponentNode(22, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                .build();
    }
        ...
        return SkillData.builder(EquipmentSlot.OFFHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(11, shieldCooldown(2), desc.shieldCooldown(), BLOCKS_ATTACKS, 0.1F)
                        .nodeRequirement(3)
                        .previousTierOrRequirements()
                    .dataComponentNode(12, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierOrRequirements()
                .tier()
    ...
    private SkillData trident() {
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                .tier()
                    ...
                    .dataComponentNode(2, durability(1), desc.durability(), DURABILITY, 200)
                .tier()
                    .dataComponentNode(3, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                    ...
                    .attributeNode(5, reach(1), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(6, beheading(1), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(9, CHANNELING, desc.channeling(), DataComponents.CHANNELING.getId(), 1, 0)
                        .previousTierOrRequirements()
                        .notNodeRequirement(7, 32)
                    .dataComponentNode(10, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(13, durability(2), desc.durability(), DURABILITY, 200)
                        ...
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(14, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(3)
                        .previousTierOrRequirements()
                    ...
                    .attributeNode(16, reach(2), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(5)
                        .previousTierOrRequirements()
                    .dataComponentNode(17, beheading(2), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(6)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .enchantmentNode(19, desc, Enchantments.LOYALTY, 2)
                        ...
                        .previousTierOrRequirements()
                        .notNodeRequirement(7, 32)
                    .dataComponentNode(20, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .nodeRequirement(10)
                        .previousTierOrRequirements()
                    .dataComponentNode(21, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(24, durability(3), desc.durability(), DURABILITY, 200)
                        ...
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(25, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(14)
                        .previousTierOrRequirements()
                    ...
                    .attributeNode(27, reach(3), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(16)
                        .previousTierOrRequirements()
                    .dataComponentNode(28, beheading(3), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(17)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .enchantmentNode(30, desc, Enchantments.LOYALTY, 3)
                        ...
                        .previousTierOrRequirements()
                        .notNodeRequirement(7, 32)
                    .dataComponentNode(31, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .nodeRequirement(20)
                        .previousTierOrRequirements()
                    .dataComponentNode(32, RIPTIDE_TOGGLE, desc.riptideToggle(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.MINE_MODE.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .infiniteDataComponentNode(35, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(24)
                        .previousTierOrRequirements()
                    .dataComponentNode(36, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(25)
                        .previousTierOrRequirements()
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .attributeNode(11, reach(1), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(12, beheading(1), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .attributeNode(15, knockbackResistance(1), desc.knockbackResistance(), attr(Attributes.KNOCKBACK_RESISTANCE), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(16, capturing(1), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .enchantmentNode(21, desc, Enchantments.SWEEPING_EDGE, 3)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(22, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                        .previousTierOrRequirements()
                    ...
                    .dataComponentNode(24, VEIN_MINING, desc.veinMining(false), DataComponents.VEIN_MINER.getId(), 1, 0)
                        .subText(VEIN_MINING_SUBTEXT, "#ABABAB")
                        .previousTierOrRequirements()
                    .dataComponentNode(25, AUTO_SMELTING, desc.autoSmelting(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_SMELT.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(26, capturing(2), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .nodeRequirement(16)
                        .previousTierOrRequirements()
                    .dataComponentNode(57, SHEARS, desc.shears(), DataComponents.SHEAR.getId(), 1)
                        ...
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(27, lifesteal(1), desc.lifesteal(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.LIFESTEAL.getId(), 2)
                        .previousTierOrRequirements()
                    ...
                    .attributeNode(29, knockbackResistance(2), desc.knockbackResistance(), attr(Attributes.KNOCKBACK_RESISTANCE), 1)
                        .nodeRequirement(15)
                        .previousTierOrRequirements()
                    .dataComponentNode(30, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(10)
                        .previousTierOrRequirements()
                    .attributeNode(31, reach(2), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(11)
                        .previousTierOrRequirements()
                    .dataComponentNode(32, beheading(2), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(12)
                        .previousTierOrRequirements()
                .tier()
                    ...
                    .dataComponentNode(36, durability(4), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(20)
                        .previousTierOrRequirements()
                    .dataComponentNode(37, AUTO_PICKUP, desc.autoPickup(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_PICKUP.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(38, capturing(3), desc.capturing(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.CAPTURING.getId(), 0.01F)
                        .nodeRequirement(26)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(39, TORCH, desc.torch(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.TORCH.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(40, MODE_SWITCH, desc.mineMode(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.MINE_MODE.getId(), 1)
                        .previousTierOrRequirements()
                    .enchantmentNode(41, desc, Enchantments.LOOTING, 3)
                        .previousTierOrRequirements()
                    .dataComponentNode(42, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(30)
                        .previousTierOrRequirements()
                    .attributeNode(43, reach(3), desc.reach(), List.of(attr(Attributes.ENTITY_INTERACTION_RANGE), attr(Attributes.BLOCK_INTERACTION_RANGE)), 1)
                        .nodeRequirement(31)
                        .previousTierOrRequirements()
                    .dataComponentNode(44, beheading(3), desc.beheading(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.BEHEADING.getId(), 0.1F)
                        .nodeRequirement(32)
                        .previousTierOrRequirements()
                .tier()
                ...
                .tier()
                    ...
                    .infiniteDataComponentNode(52, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(48)
                    .dataComponentNode(53, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(42)
                        .previousTierOrRequirements()
    ...
    private SkillData backpack() {
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                .tier()
                    ...
                    .dataComponentNode(1, filterSlots(1), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                ...
                .tier()
                    .dataComponentNode(3, capacity(2), desc.capacity(), DataComponents.CAPACITY.getId(), 1)
                        .nodeRequirement(0)
                    .dataComponentNode(4, filterSlots(2), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(1)
                .tier()
                    .dataComponentNode(5, capacity(3), desc.capacity(), DataComponents.CAPACITY.getId(), 1)
                        .nodeRequirement(3)
                    .dataComponentNode(6, filterSlots(3), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(4)
                ...
                .tier()
                    .dataComponentNode(8, capacity(4), desc.capacity(), DataComponents.CAPACITY.getId(), 1)
                        .nodeRequirement(5)
                    .dataComponentNode(9, filterSlots(4), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(6)
                .tier()
                    .dataComponentNode(10, capacity(5), desc.capacity(), DataComponents.CAPACITY.getId(), 1)
                        .nodeRequirement(8)
                    .dataComponentNode(11, filterSlots(5), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(9)
                ...
                .tier()
                    .dataComponentNode(13, capacity(6), desc.capacity(), DataComponents.CAPACITY.getId(), 1)
                        .nodeRequirement(10)
                    .dataComponentNode(14, filterSlots(6), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(11)
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(5, magnetRange(2), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                        .nodeRequirement(2)
                .tier()
                    .dataComponentNode(6, filterSlots(1), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .previousTierOrRequirements()
                    .dataComponentNode(7, unbreaking(1), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                ...
                .tier()
                    ...
                    .dataComponentNode(14, magnetRange(4), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                        .nodeRequirement(11)
                .tier()
                    .dataComponentNode(15, filterSlots(2), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(6)
                        .previousTierOrRequirements()
                    .dataComponentNode(16, unbreaking(2), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                ...
                .tier()
                    ...
                    .dataComponentNode(23, magnetRange(6), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                        .nodeRequirement(20)
                .tier()
                    .dataComponentNode(24, filterSlots(3), desc.filterSlots(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY.getId(), 1)
                        .nodeRequirement(15)
                        .previousTierOrRequirements()
                    .dataComponentNode(25, unbreaking(3), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(16)
                    ...
                    .dataComponentNode(27, AUTO_REPAIR, desc.autoRepair(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.AUTO_REPAIR.getId(), 1, 0)
                       .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(28, unbreaking(0), desc.unbreaking(), dev.willyelton.crystal.core.common.datacomponent.DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(25)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(29, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(21)
