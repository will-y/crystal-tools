...
import dev.willyelton.crystal.tools.client.model.property.Disabled;
import dev.willyelton.crystal.tools.client.model.property.FullCage;
import dev.willyelton.crystal.tools.client.model.property.Lit;
import dev.willyelton.crystal.tools.client.renderer.CrystalShieldRenderer;
import dev.willyelton.crystal.tools.client.renderer.CrystalTridentSpecialRenderer;
import dev.willyelton.crystal.tools.client.renderer.item.properties.BowUseDuration;
...
public class CrystalToolsModels extends ModelProvider {
    ...
    private void generateCrystalTrident(ItemModelGenerators itemModels) {
        ...
        ItemModel.Unbaked itemmodel$unbaked1 = ItemModelUtils.specialModel(
                CrystalToolsModelTemplates.CRYSTAL_TRIDENT_IN_HAND.create(tridentItem, TextureMapping.particle(Registration.CRYSTAL_BLOCK.get()), itemModels.modelOutput),
                new CrystalTridentSpecialRenderer.Unbaked()
        );
        ItemModel.Unbaked itemmodel$unbaked2 = ItemModelUtils.specialModel(
                CrystalToolsModelTemplates.CRYSTAL_TRIDENT_THROWING.create(tridentItem, TextureMapping.particle(Registration.CRYSTAL_BLOCK.get()), itemModels.modelOutput),
                new CrystalTridentSpecialRenderer.Unbaked()
        );
