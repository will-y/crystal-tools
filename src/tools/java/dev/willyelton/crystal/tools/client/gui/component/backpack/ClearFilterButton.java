...
public class ClearFilterButton extends BackpackActionButton {
    public ClearFilterButton(int x, int y, Screen screen, SubScreenContainerMenu container) {
        super(x, y, Component.literal("Clear Filters"), BackpackAction.CLEAR_FILTERS, 48, screen, container);
    }
}
