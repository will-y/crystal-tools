...
public class CrystalBackpackInventory extends ListComponentItemHandler {
    ...
    public CrystalBackpackInventory(int size) {
        super(ItemAccess.forStack(new ItemStack(ModRegistration.CRYSTAL_BACKPACK)), dev.willyelton.crystal.core.common.datacomponent.DataComponents.ITEM_INVENTORY.get(), size);
    }

    public CrystalBackpackInventory(ItemStack stack, ItemAccess access) {
        super(access, dev.willyelton.crystal.core.common.datacomponent.DataComponents.ITEM_INVENTORY.get(), (stack.getOrDefault(DataComponents.CAPACITY, 0) + 1) * 9);
    }
