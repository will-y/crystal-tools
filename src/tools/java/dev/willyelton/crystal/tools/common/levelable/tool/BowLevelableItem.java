...
public class BowLevelableItem extends BowItem implements LevelableItem, EntityTargeter {
    public BowLevelableItem(Properties properties) {
        super(properties
                ...
                if (((double) power >= 0.1D)) {
                    ...
                    if (!level.isClientSide()) {
                        ...
                        if (abstractarrow instanceof Arrow arrow) {
                            List<MobEffectInstance> effects = stack.getOrDefault(dev.willyelton.crystal.core.common.datacomponent.DataComponents.EFFECTS, Collections.emptyList());
