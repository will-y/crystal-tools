...
import dev.willyelton.crystal.core.common.inventory.SlotFactory;
...
import dev.willyelton.crystal.tools.common.inventory.CompressionItemStackHandler;
...
import dev.willyelton.crystal.core.common.inventory.container.slot.ReadOnlySlot;
import dev.willyelton.crystal.core.common.inventory.container.slot.ScrollableSlot;
import dev.willyelton.crystal.core.common.inventory.container.slot.FilterSlot;
import dev.willyelton.crystal.tools.common.inventory.container.slot.backpack.CompressionInputSlot;
import dev.willyelton.crystal.tools.common.inventory.container.slot.backpack.CompressionOutputSlot;
import dev.willyelton.crystal.core.common.inventory.container.subscreen.FilterContainerMenu;
import dev.willyelton.crystal.core.common.inventory.container.subscreen.FilterMenuContents;
...
import static dev.willyelton.crystal.core.common.inventory.container.SubScreenType.COMPRESS;
import static dev.willyelton.crystal.core.common.inventory.container.SubScreenType.FILTER;
import static dev.willyelton.crystal.core.common.inventory.container.SubScreenType.NONE;
import static dev.willyelton.crystal.core.utils.constants.ApiConstants.FILTER_SLOTS_PER_ROW;
...
public class CrystalBackpackContainerMenu extends BaseContainerMenu implements ScrollableMenu, SubScreenContainerMenu, FilterContainerMenu {
    ...
    public CrystalBackpackContainerMenu(int containerId, Inventory playerInventory, ItemStack stack, int slotIndex) {
        ...
        this.filterRows = stack.getOrDefault(dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_CAPACITY, 0);
        this.filterMenuContents = new FilterMenuContents<>(this, filterRows * FILTER_SLOTS_PER_ROW, stack.getOrDefault(dev.willyelton.crystal.core.common.datacomponent.DataComponents.WHITELIST, true));
    ...
    public void setWhitelist(boolean whitelist) {
        ...
        stack.set(dev.willyelton.crystal.core.common.datacomponent.DataComponents.WHITELIST, whitelist);
    }
    ...
    public ResourceHandler<ItemResource> getFilterInventory() {
        ...
        return new ItemAccessItemHandler(ItemAccess.forStack(stack), dev.willyelton.crystal.core.common.datacomponent.DataComponents.FILTER_INVENTORY.get(), filterRows * FILTER_SLOTS_PER_ROW);
    }
