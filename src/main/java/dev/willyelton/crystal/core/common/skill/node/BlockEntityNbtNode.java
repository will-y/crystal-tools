...
public class BlockEntityNbtNode extends SkillDataNode implements BlockEntityNode {
    public static final Codec<BlockEntityNbtNode> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.listOf().fieldOf("key").forGetter(BlockEntityNbtNode::getKeys),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BlockEntityNbtNode> STREAM_CODEC = StreamCodec.composite(
            ...
            Identifier.STREAM_CODEC.apply(ByteBufCodecs.list()), BlockEntityNbtNode::getKeys,
    ...
    public BlockEntityNbtNode(int id, String name, String description, int limit, List<Identifier> keys, float value, List<SkillDataRequirement> requirements, Optional<SkillSubText> skillSubText) {
