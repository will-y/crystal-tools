...
public class ClearFilterButton extends CrystalToolsButton {
    private static final int BUTTON_SIZE = 12;
    private static final int TEXTURE_Y = 281;

    public ClearFilterButton(int x, int y, OnPress onPress, OnTooltip onToolTip) {
        super(x, y, BUTTON_SIZE, BUTTON_SIZE, Component.literal("Clear Filters"), onPress, onToolTip);
    }

    @Override
    protected void blitButton(GuiGraphics guiGraphics, int textureY) {
        guiGraphics.blit(TEXTURE, getX(), getY(), 48, textureY, BUTTON_SIZE, BUTTON_SIZE, 512, 512);
    }
