...
public class CrystalToolsModels extends ModelProvider {
    ...
    private void generateCrystalShield(ItemModelGenerators itemModels) {
        ...
        ItemModel.Unbaked normal = ItemModelUtils.specialModel(CrystalToolsModelTemplates.CRYSTAL_SHIELD.create(shieldItem, TextureMapping.particle(ModRegistration.CRYSTAL_BLOCK.get()), itemModels.modelOutput),
