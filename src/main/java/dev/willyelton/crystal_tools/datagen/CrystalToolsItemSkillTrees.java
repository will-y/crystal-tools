...
public class CrystalToolsItemSkillTrees {
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                ...
                .tier()
                    ...
                    .dataComponentNode(20, AUTO_SMELTING, desc.autoSmelting(), DataComponents.AUTO_SMELT.getId(), 1)
                        .previousTierOrRequirements()
                    .optional(name.equals("Hoe"))
                        .dataComponentNode(30, SHEARS, desc.shears(), DataComponents.SHEAR.getId(), 1)
                        .itemRequirement(Items.SHEARS)
                        .previousTierOrRequirements()
                    .endOptional()
                .tier()
    ...
    private SkillData magnet() {
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                .tier()
                    .dataComponentNode(0, durability(1), desc.durability(), DURABILITY, 200)
                    .dataComponentNode(1, itemSpeed(1), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                    .dataComponentNode(2, magnetRange(1), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                .tier()
                    .dataComponentNode(3, durability(2), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(0)
                    .dataComponentNode(4, itemSpeed(2), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                        .nodeRequirement(1)
                ...
                .tier()
                    ...
                    .dataComponentNode(7, unbreaking(1), desc.unbreaking(), DataComponents.UNBREAKING.getId(), 0.1F)
                        .previousTierOrRequirements()
                    .dataComponentNode(8, PULL_XP, desc.pullXp(), DataComponents.PULL_XP.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(9, durability(3), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(3)
                        .previousTierOrRequirements()
                    .dataComponentNode(10, itemSpeed(3), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                        .nodeRequirement(4)
                        .previousTierOrRequirements()
                    .dataComponentNode(11, magnetRange(3), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                        .nodeRequirement(5)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(12, durability(4), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(9)
                    .dataComponentNode(13, itemSpeed(4), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                        .nodeRequirement(10)
                ...
                .tier()
                    ...
                    .dataComponentNode(16, unbreaking(2), desc.unbreaking(), DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                    .dataComponentNode(17, PULL_MOBS, desc.pullMobs(), DataComponents.PULL_MOBS.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(18, durability(5), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(12)
                        .previousTierOrRequirements()
                    .dataComponentNode(19, itemSpeed(5), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                        .nodeRequirement(13)
                        .previousTierOrRequirements()
                    .dataComponentNode(20, magnetRange(5), desc.magnetRange(), DataComponents.MAGNET_RANGE.getId(), 1)
                        .nodeRequirement(14)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(21, durability(6), desc.durability(), DURABILITY, 200)
                        .nodeRequirement(18)
                    .dataComponentNode(22, itemSpeed(6), desc.itemSpeed(), DataComponents.ITEM_SPEED.getId(), 0.05F)
                        .nodeRequirement(19)
                ...
                .tier()
                    ...
                    .dataComponentNode(25, unbreaking(3), desc.unbreaking(), DataComponents.UNBREAKING.getId(), 0.1F)
                        .nodeRequirement(16)
                        .previousTierOrRequirements()
                    .dataComponentNode(26, INSTANT_PICKUP, desc.instantPickup(), DataComponents.INSTANT_PICKUP.getId(), 1)
                        .previousTierAndRequirements()
                    .dataComponentNode(27, AUTO_REPAIR, desc.autoRepair(), DataComponents.AUTO_REPAIR.getId(), 1, 0)
                       .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(28, unbreaking(0), desc.unbreaking(), DataComponents.UNBREAKING.getId(), 0.01F, 70)
                        .nodeRequirement(25)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(29, durability(0), desc.durability(), DURABILITY, 50)
                        .nodeRequirement(21)
    ...
    private SkillData portableGenerator() {
        ...
        return SkillData.builder(EquipmentSlot.MAINHAND)
                .tier()
                    .dataComponentNode(0, feGeneration(1), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                    .dataComponentNode(1, fuelEfficiency(1), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                    .dataComponentNode(2, feCapacity(1), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                    .dataComponentNode(3, portableGeneratorSlots(1), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                .tier()
                    .dataComponentNode(4, feGeneration(2), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(0)
                    .dataComponentNode(5, fuelEfficiency(2), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(1)
                    .dataComponentNode(6, feCapacity(2), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(2)
                    .dataComponentNode(7, portableGeneratorSlots(2), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                        .nodeRequirement(3)
                .tier()
                    .dataComponentNode(8, METAL_GENERATOR, desc.metalGenerator(), DataComponents.METAL_GENERATOR.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(9, feGeneration(3), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(4)
                        .previousTierOrRequirements()
                    .dataComponentNode(10, fuelEfficiency(3), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(5)
                        .previousTierOrRequirements()
                    .dataComponentNode(11, feCapacity(3), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(6)
                        .previousTierOrRequirements()
                    .dataComponentNode(12, portableGeneratorSlots(3), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                        .nodeRequirement(7)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(13, feGeneration(4), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(9)
                    .dataComponentNode(14, fuelEfficiency(4), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(10)
                    .dataComponentNode(15, feCapacity(4), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(11)
                    .dataComponentNode(16, portableGeneratorSlots(4), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                        .nodeRequirement(12)
                .tier()
                    .dataComponentNode(17, FOOD_GENERATOR, desc.metalGenerator(), DataComponents.FOOD_GENERATOR.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(18, feGeneration(5), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(13)
                        .previousTierOrRequirements()
                    .dataComponentNode(19, fuelEfficiency(5), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(14)
                        .previousTierOrRequirements()
                    .dataComponentNode(20, feCapacity(5), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(15)
                        .previousTierOrRequirements()
                    .dataComponentNode(21, portableGeneratorSlots(5), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                        .nodeRequirement(16)
                        .previousTierOrRequirements()
                .tier()
                    .dataComponentNode(22, feGeneration(6), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(18)
                    .dataComponentNode(23, fuelEfficiency(6), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(19)
                    .dataComponentNode(24, feCapacity(6), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(20)
                    .dataComponentNode(25, portableGeneratorSlots(6), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1)
                        .nodeRequirement(21)
                .tier()
                    .dataComponentNode(26, GEM_GENERATOR, desc.gemGenerator(), DataComponents.GEM_GENERATOR.getId(), 1)
                        .previousTierOrRequirements()
                .tier()
                    .infiniteDataComponentNode(27, feGeneration(0), desc.feGeneration(), DataComponents.FE_GENERATION.getId(), 1)
                        .nodeRequirement(22)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(28, fuelEfficiency(0), desc.fuelEfficiency(), DataComponents.FUEL_EFFICIENCY.getId(), 0.1F)
                        .nodeRequirement(23)
                        .previousTierOrRequirements()
                    .infiniteDataComponentNode(29, feCapacity(0), desc.feCapacity(), DataComponents.FE_CAPACITY.getId(), 1)
                        .nodeRequirement(24)
                        .previousTierOrRequirements()
                    .dataComponentNode(30, portableGeneratorSlots(0), desc.portableGeneratorSlots(), DataComponents.PORTABLE_GENERATOR_SLOTS.getId(), 1, 20)
                        .nodeRequirement(25)
                        .previousTierOrRequirements()
                .build();
    }
