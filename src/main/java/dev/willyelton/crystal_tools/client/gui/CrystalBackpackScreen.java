    ...
    protected void init() {
        ...
        this.addRenderableWidget(new BackpackScreenButton(this.leftPos - 21, screenButtonY, Component.literal("Open Skill Tree"),
                button -> {
                    ...
                    if (levelable != null) {
                        ModGUIs.openScreen(new UpgradeScreen(menu.getSlotIndex(), menu.getPlayer(), () -> PacketDistributor.sendToServer(new OpenBackpackPayload(menu.getSlotIndex())), levelable.getSkillTree(), levelable.getKey()));
                    }
                },
