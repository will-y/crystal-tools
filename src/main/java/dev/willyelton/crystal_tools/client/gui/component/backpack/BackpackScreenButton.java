...
public class BackpackScreenButton extends CrystalToolsButton {
    ...
    protected void blitButton(GuiGraphics guiGraphics, int textureY) {
        ...
        if (badgeCounter > 0) {
            ...
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, getX() - badgeWidth + 2 + 5, getY() - 3, 0, 375, badgeWidth / 2, 10, 512, 512);
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, getX() - badgeWidth / 2 + 7, getY() - 3, 66 - badgeWidth / 2.0F, 375, badgeWidth / 2, 10, 512, 512);
