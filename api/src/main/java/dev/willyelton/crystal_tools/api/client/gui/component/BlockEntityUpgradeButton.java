...
public class BlockEntityUpgradeButton extends CrystalToolsButton {
    public static final Identifier BUTTON_LOCATION = Identifier.fromNamespaceAndPath(ApiConstants.CORE_MOD_ID, "textures/gui/furnace_button.png");
    ...
    protected void blitButton(GuiGraphicsExtractor guiGraphics, int textureY) {
        ...
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, BUTTON_LOCATION, this.getX() + this.width / 2, this.getY(), 200 - this.width / 2, textureY * this.height, this.width / 2, this.height, 256, 256);
    }
