package dev.willyelton.crystal_tools.api.common.network;

import dev.willyelton.crystal_tools.api.common.network.handler.BlockSkillHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ContainerRowsHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.EntitySkillHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.OpenContainerHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.OpenSubScreenHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.PointsFromXpHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.RemoveItemHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ResetSkillsBlockHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ResetSkillsHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ScrollHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ToolHealHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.ToolSkillHandler;
import dev.willyelton.crystal_tools.api.common.network.handler.UpdateSideConfigHandler;
import dev.willyelton.crystal_tools.api.common.network.payload.BlockSkillPayload;
import dev.willyelton.crystal_tools.api.common.network.payload.ContainerRowsPayload;
...
import dev.willyelton.crystal_tools.api.common.network.payload.OpenSubScreenPayload;
import dev.willyelton.crystal_tools.api.common.network.payload.PointsFromXpPayload;
import dev.willyelton.crystal_tools.api.common.network.payload.RemoveItemPayload;
...
import dev.willyelton.crystal_tools.api.common.network.payload.ToolSkillPayload;
